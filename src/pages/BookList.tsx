...
const StyledSwiper = styled(Swiper)`
  ...
  .swiper-button-prev {
    left: 10px !important; /* 음수 대신 양수로 변경 */
    top: 50% !important;
  ...
  .swiper-button-next {
    right: 10px !important; /* 음수 대신 양수로 변경 */
    top: 50% !important;
    transform: translateY(-50%) !important;
    z-index: 10;
  }
  ...
  .swiper-pagination {
    bottom: 10px !important; /* 아래쪽에 여유 공간 */
